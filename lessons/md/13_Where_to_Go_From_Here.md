...
I was scrolling Instagram one day when [@reloadingallday](https://www.instagram.com/reloadingallday/reels/?hl=en) appeared. What caught my attention INSTANTLY was seeing someone show rigorous testing results with statistically significant sample sizes—30, 50, 100+ rounds per condition. Real confidence intervals. Full data sets, not cherry-picked groups.
...
Blake has published controlled studies on topics like [seating depth effects](https://www.reloadingallday.com/post/i-failed-to-prove-seating-depth-matters) and [primer selection](https://www.reloadingallday.com/post/do-primers-affect-consistency), the same studies referenced in Appendix B of this curriculum. He tests with proper sample sizes, uses statistical analysis, and publishes results even when they contradict his own hypotheses or popular beliefs.
...
Visit [Reloading All Day](https://www.reloadingallday.com/) to explore course options.
...
- **Denton Bramwell** - ["The Perverse Nature of Standard Deviation"](http://www.65guys.com/10-round-group-size/) (statistical foundations)

### Online Resources:
- [Reloading All Day](https://www.reloadingallday.com/) - Blake's website with courses, blog articles, and testing data
- [Applied Ballistics](https://appliedballisticsllc.com/) - Bryan Litz's research and software
- [The Science of Accuracy](https://thescienceofaccuracy.com/) - Bryan Litz's Blog
...
[← Back to Lesson 12: What About The Pros?](12_What_About_The_Pros.html) | [Return to Main Index](../../README.md)
