...
ax1.text(0.5, 0.98,
        f'Full Factorial: {levels_per_factor}×{levels_per_factor}×{levels_per_factor} = {total_combos_simple} combinations\n'
        f'With {shots_per_combo} shots each = {total_combos_simple * shots_per_combo} total rounds!',
